...
function PrimaryButton({ id, label, onClick, type }) {
  return (
    <button
...
function AccentButton({ id, label, onClick, type }) {
  return (
    <button
...
function LoginButton({ id, label, onClick, type }) {
  return (
    <button
...
function SignupButton({ id, label, onClick, type }) {
  return (
    <button
...
function GoogleButton({ id, label, onClick, type }) {
  return (
    <button
